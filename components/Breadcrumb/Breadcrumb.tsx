  ...
  return useMemo(() => {
    ...
    const resolved = mergeTokenSources(sources, {
      fallbacks: (() => {
        ...
        Object.entries(DEFAULT_BREADCRUMB_TOKENS).forEach(([k, v]) => {
          fb[`breadcrumb-${k}`] = v;
        });
        return fb;
      })(),
...
const Breadcrumb: React.FC<BreadcrumbProps> = ({
  ...
  const safeSeparator = safeTokenValue(separator, 'slash', (v) =>
    ['slash', 'chevron', 'dot', 'custom'].includes(v as string)
