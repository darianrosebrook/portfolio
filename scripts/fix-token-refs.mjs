...
const REPLACEMENTS = {
  ...
  '{semantic.color.background.accentSubtle}':
  ...
  '{semantic.color.feedback.danger.default}':
    '{semantic.color.foreground.danger}',
  '{semantic.color.feedback.error.background}':
    '{semantic.color.background.dangerSubtle}',
  '{semantic.color.feedback.error.background.active}':
    '{semantic.color.background.active}',
  '{semantic.color.feedback.error.background.hover}':
    '{semantic.color.background.hover}',
  '{semantic.color.feedback.success.border}':
  ...
  '{semantic.form.density.regular.gapY}':
    '{semantic.spacing.density.compact.sm}',
  '{semantic.form.density.regular.labelFontSize}':
    '{semantic.typography.body.small.fontSize}',
  '{semantic.form.density.regular.padX}':
    '{semantic.spacing.density.compact.md}',
  '{semantic.form.density.regular.padY}':
    '{semantic.spacing.density.compact.sm}',
  ...
  '{semantic.typography.fontSize.body.default}':
    '{semantic.typography.body.default.fontSize}',
  '{semantic.typography.fontSize.body.sm}':
    '{semantic.typography.body.small.fontSize}',
  '{semantic.typography.fontSize.body.xs}':
    '{semantic.typography.meta.caption.fontSize}',
  '{semantic.typography.fontWeight.body.default}':
    '{semantic.typography.fontWeight.regular}',
  '{semantic.typography.fontWeight.body.strong}':
    '{semantic.typography.fontWeight.bold}',
  '{semantic.typography.fontWeight.normal}':
    '{semantic.typography.fontWeight.regular}',
  '{semantic.typography.fontWeight.semibold}':
    '{semantic.typography.fontWeight.medium}',
  '{semantic.typography.lineHeight.body.default}':
    '{semantic.typography.body.default.lineHeight}',
  '{semantic.typography.lineHeight.default}':
    '{semantic.typography.lineHeight.normal}',
  '{semantic.typography.lineHeight.relaxed}':
...
for (const name of componentDirs) {
  ...
  if (DRY_RUN) {
    console.log(
      `${YELLOW}Would fix: ${name} (${count} replacement(s))${RESET}`
    );
  } else {
