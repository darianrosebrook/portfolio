...
export const useScrollPosition = (elementRef) => {
  ...
  useEffect(() => {
    ...
    const calculatePosition = () => {
      ...
      const viewportMiddlePosition =
        window.visualViewport.offsetTop + window.visualViewport.height / 2; // Middle of the viewport
      const elementMiddlePosition = rect.top + rect.height / 2; // Middle of the element

      const position =
        (elementMiddlePosition - viewportMiddlePosition) /
