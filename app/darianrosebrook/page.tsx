...
export default async function Page() {
  let profile: Awaited<ReturnType<typeof fetchBlueskyData>>['profile'];
  let posts: Awaited<ReturnType<typeof fetchBlueskyData>>['posts'];
  try {
    ({ profile, posts } = await fetchBlueskyData());
  } catch (error) {
  ...
  const description = (
    <>
      ...
      <p className={styles.description}>
        ...
        intelligent, inclusive systems that empower cross-functional teams to do
        their best work.
      </p>
    </>
  );
