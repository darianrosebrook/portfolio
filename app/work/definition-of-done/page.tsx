    ...
    return (
        <section className="content">
            ...
            <article className={Styles.articleContent}>
                ...
                <p>
                    Standardizing handoff between design and development requires a handful of common checks and practices for designers to go through to consider their work “Ready” for another person to review and work on. We’re working on these standards in collaboration with teams like Content, Accessibility, Project Management, and more.
                </p>
                <p>
