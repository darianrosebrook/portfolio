'use client';
import EnhancedCompoundPage from './enhanced-page';
...
export default function Page() {
  return (
    ...
    //           label. A table row always assumes a parent table. A card usually pairs
    //           heading, body, and actions in a fixed layout.
    //         </p>
    //         <p>The compound layer is where convention becomes codified.</p>
    //         <h2>Characteristics of Compounds</h2>
    //         <ul>
    //           <li>
    //             Predictable combinations: the system says, “these primitives always
    //             travel together.”
    //           </li>
    //           <li>
    ...
    //           </li>
    //           <li>
    //             Consistent behavior: accessibility rules (like label associations)
    //             are guaranteed, not optional.
    //           </li>
    //         </ul>
    ...
    //           </li>
    //           <li>
    //             Define approved variations (e.g., TextField can have optional helper
    //             text, but never hides the label).
    //           </li>
    //         </ul>
    ...
    //           </li>
    //           <li>
    //             Example: a TextField enforces label placement and aria-describedby
    //             linking to the error state.
    //           </li>
    //         </ul>
    //         <h3>3. Flexibility Without Drift</h3>
    //         <ul>
    //           <li>
    //             Compounds should allow a controlled amount of flexibility (slots,
    //             optional props).
    //           </li>
    //           <li>
    //             The key is to prevent unbounded prop creep—flexibility should follow
    ...
    //               </li>
    //               <li>
    //                 Guardrail: compounds support only the blessed variations. If you
    //                 find yourself adding a boolean every sprint, you’ve crossed
    //                 layers.
    //               </li>
    //             </ul>
    //           </li>
    ...
    //             <ul>
    //               <li>
    //                 A text field without a proper &lt;label&gt; or aria-describedby
    //                 is a broken compound.
    //               </li>
    //               <li>
    ...
    //               </li>
    //               <li>
    //                 Guardrail: fix the expected structure, allow slots for content.
    //               </li>
    //             </ul>
    //           </li>
    //           <li>
    ...
    //             <ul>
    //               <li>
    //                 Don’t reimplement primitive behaviors inside compounds (e.g.,
    //                 don’t reinvent Checkbox logic inside a “FilterRow” compound).
    //               </li>
    //               <li>
    ...
    //         <ul>
    //           <li>
    //             The Input primitive is still used, but labeling, error messaging,
    //             and helper text are orchestrated once.
    //           </li>
    //           <li>
    ...
    //         <ul>
    //           <li>
    //             They reduce cognitive load: designers and engineers don’t have to
    //             reassemble primitives every time.
    //           </li>
    //           <li>
    //             They prevent inconsistent conventions: spacing, order, accessibility
    //             are centralized.
    //           </li>
    //           <li>
    ...
    //           </li>
    //           <li>
    //             They create legibility in design files and codebases: “TextField”
    //             communicates intent better than “Input + Label + Error stacked
    //             manually.”
    //           </li>
    //         </ul>
    //         <h2>Summary</h2>
    ...
    //             primitives
    //           </Link>{' '}
    //           are the boring DNA, compounds are the grammar rules—they make sure the
    //           words can be combined into predictable, legible sentences.
    //         </p>
