 ...
 * Status Component
 *
 * A status indicator with a distinctive star/sparkle icon.
 * Used for displaying availability or state messages.
 *
 * @example
 * <Status status="success">Available for work</Status>
